...
public:
	ImageDesignStartMessage(CreatureObject* object, CreatureObject* designer, CreatureObject* targetPlayer, uint64 tentID, const String& hairTemplate) : ObjectControllerMessage(object->getObjectID(), 0x1B, 0x023A) {
