...
#define CLEAR_LOCK_TRACE()                                       \
	Thread::getCurrentThread()->getLockableTrace()->removeAll(); \
	Thread::getCurrentThread()->getAcquiredLockables()->removeAll()
...
public:                                                                                         \
	...
	void lock(bool doLock = true) {                                                             \
		if (doLock) {                                                                           \
			Thread::getCurrentThread()->addAcquiredLockable(this, nullptr, _monitorLockable);   \
