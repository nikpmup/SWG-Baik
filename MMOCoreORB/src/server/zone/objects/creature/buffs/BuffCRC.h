...
public:
	// TEST
	enum { TEST_FIRST = 0x1967AF38, TEST_SECOND = 0xA24A7A5B };

	// MEDICAL
	enum { MEDICAL_ENHANCE_HEALTH = 0x98321369, MEDICAL_ENHANCE_STRENGTH = 0x815D85C5, MEDICAL_ENHANCE_CONSTITUTION = 0x7F86D2C6, MEDICAL_ENHANCE_ACTION = 0x4BF616E2, MEDICAL_ENHANCE_QUICKNESS = 0x71B5C842, MEDICAL_ENHANCE_STAMINA = 0xED0040D9, MEDICAL_ENHANCE_POISON = 0x391AC375, MEDICAL_ENHANCE_DISEASE = 0x3595876 };

	// PERFORMANCE
	enum { PERFORMANCE_ENHANCE_DANCE_MIND = 0x11C1772E, PERFORMANCE_ENHANCE_MUSIC_FOCUS = 0x2E77F586, PERFORMANCE_ENHANCE_MUSIC_WILLPOWER = 0x3EC6FCB6 };
	...
	// FORCE_RANK
	enum { FORCE_RANK_SUFFERING = 0xF531B147, FORCE_RANK_SERENITY = 0xA09E5934 };
	...
	// INNATE
	enum { INNATE_BUFF_REGENERATION = 0xD1514A47, INNATE_BUFF_VITALIZE = 0x477D7E4 };
