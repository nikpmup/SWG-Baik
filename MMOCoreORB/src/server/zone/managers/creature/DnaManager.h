...
public:
	...
	enum { FORTITUDE = 1, ENDURANCE = 2, CLEVERNESS = 3, INTELLIGENCE = 4, DEXTERITY = 5, HARDINESS = 6, DEPENDABILITY = 7, COURAGE = 8, POWER = 9, FIERCENESS = 10 };
	enum { HIT_LEVEL = 1, HAM_LEVEL = 2, DPS_LEVEL = 3, ARM_LEVEL = 4, REG_LEVEL = 5 };
