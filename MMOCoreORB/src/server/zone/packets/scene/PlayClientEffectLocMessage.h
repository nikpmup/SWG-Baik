...
public:
	...
	PlayClientEffectLoc(const String& file, const String& zoneName, float x, float z, float y, uint64 cell = 0, int terrainDelta = 0, const String& label = "") : BaseMessage(), listSize(0) {
		/* Struct
		 * 09 00 // Operand
		 * 74 9E 94 02 // Opcode
		 * A_STRING (effect)
