...
public:
	HoloEmoteCommand(const String& name, ZoneProcessServer* server) : QueueCommand(name, server) {
	}
	...
	bool isValidArgument(const String& arg) const {
		if (arg == "help" || arg == "beehive" || arg == "blossom" || arg == "brainstorm" || arg == "bubblehead" || arg == "bullhorns" || arg == "butterflies" || arg == "champagne" || arg == "haunted" || arg == "hearts" || arg == "hologlitter" || arg == "holonotes" || arg == "imperial" || arg == "technokitty" ||
			arg == "kitty" || // Alias for technokitty
			arg == "phonytail" || arg == "rebel" || arg == "sparky" || arg == "delete") {
			return true;
		}
